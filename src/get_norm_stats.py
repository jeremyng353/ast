...
train_loader = torch.utils.data.DataLoader(
    dataloader.AudiosetDataset('./egs/isolatedurban/data/datafiles/train_data_isolatedurban.json', label_csv='./egs/isolatedurban/data/isolatedurban_label_indices.csv',
