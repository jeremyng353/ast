...
parser.add_argument("--dataset", type=str, default="audioset", help="the dataset used", choices=["audioset", "esc50", "speechcommands", 'isolatedurban'])
...
if args.model == 'ast':
    ...
    print(f'input_tdim: {target_length[args.dataset]}')
