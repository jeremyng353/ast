...
then
  ...
  lr=1e-5
  epoch=5
  tr_data=./data/datafiles/train_data_urbansound8k.json
fi
te_data=./data/datafiles/eval_data_urbansound8k.json
freqm=48
timem=192
mixup=0.5
...
--label-csv ./data/urbansound8k_labels_indices.csv --n_class 527 \
