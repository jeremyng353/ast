...
parser.add_argument("--data_path", type=str, default='./data/datafiles/train_data_isolatedurban.json', help="the root path of data json file")

if __name__ == '__main__':
    args = parser.parse_args()
    data_path = args.data_path

    index_dict = make_index_dict('./data/isolatedurban_label_indices.csv')
